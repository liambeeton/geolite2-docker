...
/opt/mssql-tools/bin/bcp GeoLite2.dbo.CityBlock in ./geolite2/GeoLite2-City-Blocks-IPv4.csv -c -t ',' -r '0x0A' -F 2 -S localhost -U sa -P Passw0rd

# import GeoLite2 City Locations
/opt/mssql-tools/bin/bcp GeoLite2.dbo.CityLocation in ./geolite2/GeoLite2-City-Locations-en.csv -c -t ',' -r '0x0A' -F 2 -S localhost -U sa -P Passw0rd